...
/**
 * 페이징 및 트랜잭션 이슈 있는 repository query 모아서 테스트. - testGetListWithPaging
 */
@Disabled
@Log4j2
...
public class BoardRepositoryTests {
    ...
    private final Function<Board, Board> boardPageConveter=new Function<Board,Board>(){@Override public Board apply(Board board){return Board.builder().boardId(board.getBoardId()).build();
    // log.info("=============apply=============");
    ...
    public void testGetListWithPaging() {
        /**
         * [이슈] Page<Board> -> Page<BoardDTO> 로 변환할때, Page<BoardDTO> boardDtoPages =
         * boardPages.map(board -> boardPageConveter.apply(board)); ... 이렇게 map 을 쓰면 다음과
         * 같은 예외 발생.
         * 
         * [Ljava.lang.Object; cannot be cast to
         * com.study.springbootjpa.miri.domain.Board]
         * 
         ...
         * 
         * 관련 키워드 - subList 와 직렬화 (https://sungminhong.github.io/java/serialize/) -
         * Class Collections.UnmodifiableCollection<E>
         * (https://runtimeverification.com/monitor/propertydb/index.html?java/util/Collections.UnmodifiableRandomAccessList.html)
         * - Class Collections 의 unmodifiableCollection 메서드
         * (https://runtimeverification.com/monitor/propertydb/index.html?java/util/Collections.UnmodifiableRandomAccessList.html)
         * => Returns an unmodifiable view of the specified collection. This method
         * allows modules to provide users with "read-only" access to internal
         * collections. Query operations on the returned collection "read through" to
         * the specified collection, and attempts to modify the returned collection,
         * whether direct or via its iterator, result in an
         * UnsupportedOperationException. - https://www.freeism.co.kr/wp/archives/1608
         */
        // 임시 Pageable
    ...
    public void testGetListWithPaging2(){
        ...
        log.info("=============boardPages.map 호출=============");
        Page<BoardDTO> boardDtoPages = boardPages.map(new Function<Board, BoardDTO>() {
            @Override
            public BoardDTO apply(Board entity) {
                return service.convertToDto(entity);
            }
        });

        log.info("=============boardDtoPages.getContent() 호출=============");
        boardDtoPages.getContent().forEach(i->{
            log.info(i.toString());
        });
